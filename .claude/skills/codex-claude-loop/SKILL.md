...
description: >-
  Coordinate Codex Sol planning and review with Claude Opus implementation through one shared
  local handoff file. Use when the two sessions take turns, optionally check for updates on a
  schedule, and stop at completion or a user decision.
---
